...
> Replace `Neekogreat/CICDTaskManager` with your own GitHub username and repository name.

![Compile](https://github.com/Neekogreat/CICDTaskManager/actions/workflows/compile.yml/badge.svg?branch=main)
![Test](https://github.com/Neekogreat/CICDTaskManager/actions/workflows/test.yml/badge.svg?branch=main)
![Build](https://github.com/Neekogreat/CICDTaskManager/actions/workflows/build.yml/badge.svg?branch=main)
![Integration Test](https://github.com/Neekogreat/CICDTaskManager/actions/workflows/integration-test.yml/badge.svg?branch=main)
![Javadoc](https://github.com/Neekogreat/CICDTaskManager/actions/workflows/javadoc.yml/badge.svg?branch=main)
